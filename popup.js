...
class BlueskyFollower {
  ...
  async initialize(username, password) {
    try {
      ...
      console.log('BskyAgent imported successfully');
...
async function saveFieldValue(field, value) {
  ...
  console.log(`Saved ${field} to storage`);
}
...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  // Add input event listeners to save values as they change
  ...
  passwordField.addEventListener('input', (e) => {
    if (rememberCheckbox.checked) {
      console.log('Password changed and remember is checked');
